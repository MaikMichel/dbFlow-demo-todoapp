...
@@application/shared_components/files/js_p1_tasks_js.sql
@@application/shared_components/files/js_p1_tasks_min_js.sql
@@application/shared_components/files/js_p1_tasks_js_map.sql
@@application/shared_components/files/css_p1_tasks_css.sql
@@application/shared_components/files/img_jenkins_png.sql
@@application/shared_components/files/css_p1_tasks_min_css.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/administration_rights.sql
@@application/shared_components/navigation/navigation_bar.sql
@@application/shared_components/logic/application_items/app_chl_date.sql
@@application/shared_components/logic/application_items/app_chl_id.sql
@@application/shared_components/logic/application_items/app_chl_link.sql
@@application/shared_components/logic/application_items/app_chl_version.sql
@@application/shared_components/logic/application_items/app_dlg_close_msg.sql
@@application/shared_components/logic/application_items/app_patch_version.sql
