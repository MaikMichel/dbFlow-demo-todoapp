...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29651857754723622)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29652338476723623)
,p_plug_template_id=>wwv_flow_imp.id(29651857754723622)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29652875335723624)
,p_plug_template_id=>wwv_flow_imp.id(29651857754723622)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29653330637723624)
,p_plug_template_id=>wwv_flow_imp.id(29651857754723622)
,p_name=>'Sub Regions'
