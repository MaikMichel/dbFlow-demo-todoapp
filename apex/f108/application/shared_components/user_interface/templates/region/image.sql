...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44698128929184460)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29536638845723571)
,p_plug_template_id=>wwv_flow_imp.id(44698128929184460)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29537143462723571)
,p_plug_template_id=>wwv_flow_imp.id(44698128929184460)
,p_name=>'Sub Regions'
