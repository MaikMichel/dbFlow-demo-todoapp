...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44720149269184467)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29594211024723596)
,p_plug_template_id=>wwv_flow_imp.id(44720149269184467)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29594701017723596)
,p_plug_template_id=>wwv_flow_imp.id(44720149269184467)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29595224677723596)
,p_plug_template_id=>wwv_flow_imp.id(44720149269184467)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29595764744723596)
,p_plug_template_id=>wwv_flow_imp.id(44720149269184467)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29596233957723596)
,p_plug_template_id=>wwv_flow_imp.id(44720149269184467)
,p_name=>'Sub Regions'
