...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44732522340184471)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29627819734723611)
,p_plug_template_id=>wwv_flow_imp.id(44732522340184471)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29628383124723612)
,p_plug_template_id=>wwv_flow_imp.id(44732522340184471)
,p_name=>'Tabs'
