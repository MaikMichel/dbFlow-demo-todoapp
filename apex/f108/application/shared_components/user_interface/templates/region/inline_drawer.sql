...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44708056595184464)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29563605240723583)
,p_plug_template_id=>wwv_flow_imp.id(44708056595184464)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29564115000723583)
,p_plug_template_id=>wwv_flow_imp.id(44708056595184464)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29564627098723583)
,p_plug_template_id=>wwv_flow_imp.id(44708056595184464)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29565188817723583)
,p_plug_template_id=>wwv_flow_imp.id(44708056595184464)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29565608405723583)
,p_plug_template_id=>wwv_flow_imp.id(44708056595184464)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29566140738723584)
,p_plug_template_id=>wwv_flow_imp.id(44708056595184464)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29566641990723584)
,p_plug_template_id=>wwv_flow_imp.id(44708056595184464)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29567114237723584)
,p_plug_template_id=>wwv_flow_imp.id(44708056595184464)
,p_name=>'Sub Regions'
