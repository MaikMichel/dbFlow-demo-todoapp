...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44669384025184450)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29461637028723539)
,p_plug_template_id=>wwv_flow_imp.id(44669384025184450)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29462127325723539)
,p_plug_template_id=>wwv_flow_imp.id(44669384025184450)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29462678471723540)
,p_plug_template_id=>wwv_flow_imp.id(44669384025184450)
,p_name=>'Sub Regions'
