...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29656141770723625)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29656646083723626)
,p_plug_template_id=>wwv_flow_imp.id(29656141770723625)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29657149436723626)
,p_plug_template_id=>wwv_flow_imp.id(29656141770723625)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29657622639723626)
,p_plug_template_id=>wwv_flow_imp.id(29656141770723625)
,p_name=>'Button Start'
