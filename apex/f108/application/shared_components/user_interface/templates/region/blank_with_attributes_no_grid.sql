...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44663724776184448)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29447005999723535)
,p_plug_template_id=>wwv_flow_imp.id(44663724776184448)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29447596903723535)
,p_plug_template_id=>wwv_flow_imp.id(44663724776184448)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29448089022723535)
,p_plug_template_id=>wwv_flow_imp.id(44663724776184448)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29448564704723536)
,p_plug_template_id=>wwv_flow_imp.id(44663724776184448)
,p_name=>'Sub Regions'
