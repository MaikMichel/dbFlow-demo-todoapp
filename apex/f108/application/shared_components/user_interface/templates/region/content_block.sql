...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44690675471184457)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29518085216723562)
,p_plug_template_id=>wwv_flow_imp.id(44690675471184457)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29518524970723562)
,p_plug_template_id=>wwv_flow_imp.id(44690675471184457)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29519070308723562)
,p_plug_template_id=>wwv_flow_imp.id(44690675471184457)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29519597801723562)
,p_plug_template_id=>wwv_flow_imp.id(44690675471184457)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29520039460723563)
,p_plug_template_id=>wwv_flow_imp.id(44690675471184457)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29520529074723563)
,p_plug_template_id=>wwv_flow_imp.id(44690675471184457)
,p_name=>'Sub Regions'
