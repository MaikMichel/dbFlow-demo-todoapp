...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44718095069184467)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29588847672723593)
,p_plug_template_id=>wwv_flow_imp.id(44718095069184467)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29589330056723594)
,p_plug_template_id=>wwv_flow_imp.id(44718095069184467)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29589870360723594)
,p_plug_template_id=>wwv_flow_imp.id(44718095069184467)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29590365317723594)
,p_plug_template_id=>wwv_flow_imp.id(44718095069184467)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29590895632723594)
,p_plug_template_id=>wwv_flow_imp.id(44718095069184467)
,p_name=>'Sub Regions'
