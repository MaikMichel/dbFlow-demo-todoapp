...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44681232083184454)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29493425229723551)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29493929551723551)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29494465757723551)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29494942689723551)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29495431927723551)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29495915570723552)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29496473367723552)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29496968520723552)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29497411487723552)
,p_plug_template_id=>wwv_flow_imp.id(44681232083184454)
,p_name=>'Sub Regions'
