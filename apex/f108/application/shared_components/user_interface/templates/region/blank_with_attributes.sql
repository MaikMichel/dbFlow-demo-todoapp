...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44662338917184448)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29443146815723534)
,p_plug_template_id=>wwv_flow_imp.id(44662338917184448)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29443686335723534)
,p_plug_template_id=>wwv_flow_imp.id(44662338917184448)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29444110041723534)
,p_plug_template_id=>wwv_flow_imp.id(44662338917184448)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29444602160723534)
,p_plug_template_id=>wwv_flow_imp.id(44662338917184448)
,p_name=>'Sub Regions'
