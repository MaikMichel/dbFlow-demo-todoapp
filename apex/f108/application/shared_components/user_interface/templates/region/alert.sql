...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44657105031184441)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29431396336723530)
,p_plug_template_id=>wwv_flow_imp.id(44657105031184441)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29431816567723530)
,p_plug_template_id=>wwv_flow_imp.id(44657105031184441)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29432398767723530)
,p_plug_template_id=>wwv_flow_imp.id(44657105031184441)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29432855366723530)
,p_plug_template_id=>wwv_flow_imp.id(44657105031184441)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29433305715723530)
,p_plug_template_id=>wwv_flow_imp.id(44657105031184441)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29433807806723530)
,p_plug_template_id=>wwv_flow_imp.id(44657105031184441)
,p_name=>'Sub Regions'
