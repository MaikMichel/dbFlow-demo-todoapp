...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44694849328184459)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29529680441723568)
,p_plug_template_id=>wwv_flow_imp.id(44694849328184459)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29530180861723568)
,p_plug_template_id=>wwv_flow_imp.id(44694849328184459)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29530659152723568)
,p_plug_template_id=>wwv_flow_imp.id(44694849328184459)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29531172919723568)
,p_plug_template_id=>wwv_flow_imp.id(44694849328184459)
,p_name=>'Sub Regions'
