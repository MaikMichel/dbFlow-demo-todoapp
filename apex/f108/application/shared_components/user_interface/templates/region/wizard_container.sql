...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44739855908184473)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29647958097723620)
,p_plug_template_id=>wwv_flow_imp.id(44739855908184473)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29648482309723620)
,p_plug_template_id=>wwv_flow_imp.id(44739855908184473)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29648929185723620)
,p_plug_template_id=>wwv_flow_imp.id(44739855908184473)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29649455153723620)
,p_plug_template_id=>wwv_flow_imp.id(44739855908184473)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29649938477723621)
,p_plug_template_id=>wwv_flow_imp.id(44739855908184473)
