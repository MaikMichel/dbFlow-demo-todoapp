...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44703467937184462)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29552248191723579)
,p_plug_template_id=>wwv_flow_imp.id(44703467937184462)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29552735113723579)
,p_plug_template_id=>wwv_flow_imp.id(44703467937184462)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29553268376723579)
,p_plug_template_id=>wwv_flow_imp.id(44703467937184462)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29553762254723579)
,p_plug_template_id=>wwv_flow_imp.id(44703467937184462)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29554249878723579)
,p_plug_template_id=>wwv_flow_imp.id(44703467937184462)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29554793801723579)
,p_plug_template_id=>wwv_flow_imp.id(44703467937184462)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29555257989723579)
,p_plug_template_id=>wwv_flow_imp.id(44703467937184462)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29555705647723580)
,p_plug_template_id=>wwv_flow_imp.id(44703467937184462)
,p_name=>'Sub Regions'
