...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(44712690453184465)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29575913051723588)
,p_plug_template_id=>wwv_flow_imp.id(44712690453184465)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29576402464723588)
,p_plug_template_id=>wwv_flow_imp.id(44712690453184465)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29576906802723588)
,p_plug_template_id=>wwv_flow_imp.id(44712690453184465)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29577477170723589)
,p_plug_template_id=>wwv_flow_imp.id(44712690453184465)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29577986556723589)
,p_plug_template_id=>wwv_flow_imp.id(44712690453184465)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29578498200723589)
,p_plug_template_id=>wwv_flow_imp.id(44712690453184465)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29578989469723589)
,p_plug_template_id=>wwv_flow_imp.id(44712690453184465)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29579491462723589)
,p_plug_template_id=>wwv_flow_imp.id(44712690453184465)
,p_name=>'Sub Regions'
