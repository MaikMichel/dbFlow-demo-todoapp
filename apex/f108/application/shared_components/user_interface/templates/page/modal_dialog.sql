...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(44633255142184432)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29402808067723518)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29403353993723518)
,p_page_template_id=>wwv_flow_imp.id(44633255142184432)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29403856807723519)
,p_page_template_id=>wwv_flow_imp.id(44633255142184432)
